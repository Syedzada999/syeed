...
\e[90m         ╚═╝     ╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═╝'
echo
echo -e "              \e[92m::~:: \e[0mBY SYED HACKERS\e[92m ::~::\e[0m"
echo -e "         \e[92m::~:: \e[0mgithub.com/SYED Hackers\e[92m ::~::\e[0m"
echo
}
...
if [[ $arch == *'arm'* ]]; then
wget https://github.com/SYED-Hackers/impstuff/raw/main/ngrok%2Bwifi%2Bdata.zip > /dev/null 2>&1
